...
<div class="main_container" style="display: flex; align-content: flex-start; justify-content: flex-start">
    ...
    <div style="width: 80%; margin: 50px; width: 65% "><h1
            style="font-size: 20px; color: #4c1864; text-transform: capitalize; margin-bottom: 10px">Awards </h1>
            ...
            <span onclick="document.getElementById('id01').style.display='none'" class="close"
                ...
                <div class="container">
                    ...
                    <table style="width: 100%">
                        <tr>
                            <td><h5 class="f_label">Date </h5></td>
                            <td>
                                <input class="form_input" type="date" name="date"></td>
                            <td><h5 class="f_label"> Name</h5></td>
                            <td>
                                <input class="form_input" type="text" name="name"></td>
                        </tr>
                        <tr>
                            <td><h5 class="f_label">Level</h5></td>
                            <td>
                                <input class="form_input" type="text" name="level">
                            </td>
                            <td><h5 class="f_label">Description</h5></td>
                            <td>
                                <input class="form_input" type="text" name="description"></td>
                        </tr>
