...
<div class="main_container" style="display: flex; align-content: flex-start; justify-content: flex-start">
    ...
    <div style="width: 80%; margin: 50px; width: 65% "><h1
            style="font-size: 20px; color: #4c1864; text-transform: capitalize; margin-bottom: 10px">Work background </h1>


        <!-- Education  -->
        <div class="full_contain">
            <h1 class="liner"> Professional experience</h1>
            ...
            <span onclick="document.getElementById('id01').style.display='none'" class="close"
                ...
                <div class="container">
                    ...
                    <table style="width: 100%">
                        ...
                        <tr>
                            <td><h5 class="f_label">company</h5></td>
                            <td>
                                <input class="form_input" type="text" name="company">
                            </td>
                            <td><h5 class="f_label">jobtitle</h5></td>
                            <td>
                                <input class="form_input" type="text" name="jobtitle"></td>
                        </tr>
